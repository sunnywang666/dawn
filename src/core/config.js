...
function readConfig() {
  ...
  return {
    ...
    runtimeFallbackEnabled: readBoolEnv("CYBERBOSS_RUNTIME_FALLBACK_ENABLED"),
    ...
    weixinLogChunks: readBoolEnv("CYBERBOSS_WEIXIN_LOG_CHUNKS"),
    ...
    notionApiKey: readTextEnv("CYBERBOSS_NOTION_API_KEY") || readTextEnv("NOTION_API_KEY"),
    notionAssignmentsDatabaseId: readTextEnv("CYBERBOSS_NOTION_ASSIGNMENTS_DATABASE_ID"),
    notionSubjectsDatabaseId: readTextEnv("CYBERBOSS_NOTION_SUBJECTS_DATABASE_ID"),
