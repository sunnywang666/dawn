...
function mapClaudeCodeMessageToRuntimeEvent(message, raw) {
  ...
  switch (type) {
    ...
    case "process.close":
      // If pendingTurnId was already cleared by handleResult (turn.completed), the process
      // closing afterwards is expected (e.g. SessionEnd hook running post-turn). Not a failure.
