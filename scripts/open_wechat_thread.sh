...
REMOTE_URL="${DAWN_CODEX_ENDPOINT:-ws://127.0.0.1:${PORT}}"
STATE_DIR="${DAWN_STATE_DIR:-$HOME/.exclusive-dawn}"
SESSION_FILE="${DAWN_SESSIONS_FILE:-${STATE_DIR}/sessions.json}"
WORKSPACE_ROOT="${DAWN_WORKSPACE_ROOT:-$PWD}"
ACCOUNT_DIR="${STATE_DIR}/accounts"
RUNTIME_ID="${DAWN_RUNTIME:-codex}"
